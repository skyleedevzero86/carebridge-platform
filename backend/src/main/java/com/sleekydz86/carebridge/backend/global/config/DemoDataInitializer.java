...
import com.sleekydz86.carebridge.backend.server.application.emr.ExamOrderEntity;
import com.sleekydz86.carebridge.backend.server.application.emr.ExamOrderJpaRepository;
import com.sleekydz86.carebridge.backend.server.application.emr.ExamOrderStatus;
import com.sleekydz86.carebridge.backend.server.application.emr.MedicalDeviceEntity;
import com.sleekydz86.carebridge.backend.server.application.emr.MedicalDeviceJpaRepository;
import com.sleekydz86.carebridge.backend.server.application.emr.PatientEntity;
import com.sleekydz86.carebridge.backend.server.application.emr.PatientJpaRepository;
