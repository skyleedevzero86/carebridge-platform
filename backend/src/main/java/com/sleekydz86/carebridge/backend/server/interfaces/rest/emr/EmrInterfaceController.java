package com.sleekydz86.carebridge.backend.server.interfaces.rest.emr;
...
public class EmrInterfaceController {
    ...
    public record SimulateHl7Request(
            @NotBlank(message = "메시지 ?�어 ID�??�력??주세??") String messageControlId,
            @NotBlank(message = "?�비 코드�??�력??주세??") String deviceCode,
            @NotBlank(message = "?�자 번호�??�력??주세??") String patientNo,
            @NotBlank(message = "?�더 번호�??�력??주세??") String orderNo,
            @NotBlank(message = "검??코드�??�력??주세??") String examCode,
            @NotBlank(message = "검?�명???�력??주세??") String examName,
            @NotBlank(message = "관�???�� 코드�??�력??주세??") String observationCode,
            @NotBlank(message = "관�???��명을 ?�력??주세??") String observationName,
            @NotBlank(message = "결과 값을 ?�력??주세??") String value,
            String unit,
